<?php
	...
	$id = $result_array['customer_id'];
	$name = $result_array['customer_name'];
	$email = $result_array['customer_email'];
	$pass = $result_array['customer_pass'];
	$country = $result_array['customer_country'];
	$city = $result_array['customer_city'];
	$contact = $result_array['customer_contact'];
	$address = $result_array['customer_add'];
	$image = $result_array['customer_img'];	
				}
?>
...
<form action="" method="post" enctype="multipart/form-data">
	<table align="center" width="600">
		<tr>
			<td colspan="8" align="center"><h2>Update Account</h2></td>
		<tr>
		<tr>
...
<option value="Zimbabwe">Zimbabwe</option>
		...
		<tr>
						...
						<tr align="center">
							<td colspan="8"><input type="submit" name="update_account" value="Update Account" /></td>
						</tr>
						</table>
</form>
...
if (isset($_POST['update_account'])){
		...
		$sql="update customers set customer_name='$c_name', customer_email='$c_email', customer_pass='$c_pass', customer_city='$c_city',
